...
# Limitations
The only real limitation is the translations of typings. Many of Redux's types are impossible to translate due to Luau just not being able to convert them. With that being said, the best of effort was done to convert them.